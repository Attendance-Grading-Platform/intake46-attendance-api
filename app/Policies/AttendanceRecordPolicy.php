...
class AttendanceRecordPolicy
{
    ...
    public function view(User $user, AttendanceRecord $record): bool
    {
        ...
        // ACC-3: Instructor sees attendance ONLY for sessions generated by their engagements
        if ($user->role === 'instructor') {
            return $record->session->engagement->instructor_id === $user->id;
        }
    ...
    public function update(User $user, AttendanceRecord $record): Response
    {
        ...
        // Instructor Context: Can manually fix attendance for a session they delivered
        if ($user->role === 'instructor') {
            return $record->session->engagement->instructor_id === $user->id
                ? Response::allow()
                : Response::deny('You can only modify attendance records for sessions you were assigned to teach.');
        }
